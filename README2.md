...
- США: т.к. приходится примерно 3 млн. DAU, расположим 3 ДЦ в Вирджинии, Орегоне, Техасе, покрытие  
- Бразилия: приходится примерно 0.8 млн. DAU, расположим ДЦ в столице
- Великобритания: приходится примерно 0.5 млн. DAU, расположим ДЦ в 
- Германия: приходится примерно 0.5 млн. DAU, расположим ДЦ в
- Остальная Европа и Россия: 


### Расчет распределение запросов по типам запросов по датацентрам
