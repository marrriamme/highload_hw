...
### Сетевой трафик с разными размерами данных
...
Вход в аккаунт:
- Нагрузка: (2 КБ × 289.4 RPS × 8) / 1024 = 0.45 Гбит/с

Прохождение карточек:
- Нагрузка: (8 КБ × 1,736.1 RPS × 8) / 1024 = 10.85 Гбит/с

Сопоставление слов:
- Нагрузка: (12 КБ × 723.4 RPS × 8) / 1024 = 6.78 Гбит/с

Аудирование:
- Нагрузка: (15 КБ × 578.7 RPS × 8) / 1024 = 6.78 Гбит/с

Просмотр статистики:
- Нагрузка: (25 КБ × 144.7 RPS × 8) / 1024 = 28.26 Гбит/с

Изменение уроков:
- Нагрузка: (100 КБ × 14.5 RPS × 8) / 1024 = 11.33 Гбит/с
...
Расчеты:
- пиковая нагрузка = 111.69 Гбит/с × 2 = 223.38 Гбит/с
- нагрузка с резервом = 31,123,880 Мбит × 1.5 = 35.07 Гбит/с
