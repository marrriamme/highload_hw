...
|--------------------------------------|------------------------------------------------------------------------| ---------------------------------------------------------------------------------------------- |
| PostgreSQL                           | Master + 2 реплики, Patroni для управления кластером, WAL              | Репликация данных, автоматическое переключение на реплику при падении мастера, резервные копии |
